...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['QANAPI_API_V1_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['QANAPI_API_V1_LOG'] or 'warn' if it isn't set.
   */
...
export class QanapiAPIV1 {
  ...
  constructor({
    ...
    this.timeout = options.timeout ?? QanapiAPIV1.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('QANAPI_API_V1_LOG'), "process.env['QANAPI_API_V1_LOG']", this) ??
      defaultLogLevel;
  ...
  static QanapiAPIV1 = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static QanapiAPIV1Error = Errors.QanapiAPIV1Error;
...
QanapiAPIV1.Proxy = Proxy;
export declare namespace QanapiAPIV1 {
